...
<body>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body modal-body-sub"> 
					...
					<input type="text" name="Name" placeholder="Enter your area(eg: Lokanthali) / Landmark / Pincode" required="">
		...
		<div class="header-two"><!-- header-two -->
			<div class="container">
				<div class="header-logo">
					<h1><a href="index.html"><span>S</span>amuel <i>Guitar Shop</i></a></h1>
				...
				<div class="header-cart"> 
					<div class="my-account">
						<a href="contact.html">Contact <i class="fa fa-map-marker" aria-hidden="true"></i></a>						
					</div>
					<div class="cart"> 
			...
			<div class="welcome-info">
				<div class="bs-example bs-example-tabs" role="tabpanel" data-example-id="togglable-tabs">
					...
					<?php include "NepdevSetting/config.php";
					 ...
					 $NepdevFrontDis = $NepdevG->NepdevGuitarInfo();
					if($NepdevFrontDis->num_rows>0)
					{
				
					?>
					
					<h3 class="w3ls-title">Featured Product</h3>
					<div id="myTabContent" class="tab-content">
						<div role="tabpanel" class="tab-pane fade in active" id="home" aria-labelledby="home-tab">
							<div class="tabcontent-grids">  
								<div id="owl-demo" class="owl-carousel"> 
											<?php 	while($NepdevFrontFetch=$NepdevFrontDis->fetch_assoc())
					{ ?>
									<div class="item">
                                        
										<div class="glry-w3agile-grids agileits"> 
                                            <div class="new-tag"><h6>New</h6></div>
											<a href="SingleProduct.php?id=<?php echo $NepdevFrontFetch['id']; ?>"><img src="meadmin/web/pro_img/<?php echo $NepdevFrontFetch['ProductImage']; ?>" alt="img" style="max-width:150px; max-height:179px;"></a>
											<div class="view-caption agileits-w3layouts">           
												<h4><a href="SingleProduct.php?id=<?php echo $NepdevFrontFetch['id']; ?>"><?php echo $NepdevFrontFetch['GuitarName']; ?> </a></h4>
												<p></p>
												<h4><?php echo "Rs".$NepdevFrontFetch['GuitarPrice']; ?></h4> 
												<form method="post">
												
                                                <a href="SingleProduct.php?id=<?php echo $NepdevFrontFetch['id']; ?>">View Product</a>
												</form>  
											</div>   
										</div>   
									</div>
						...
						<div role="tabpanel" class="tab-pane fade" id="carl" aria-labelledby="carl-tab">
							<div class="tabcontent-grids">
                                ...
                                <?php 
                          $DisplayProAsCat= $NepdevG->NepdevViewProCat();            
                        while($DisplayAsCat = $DisplayProAsCat->fetch_assoc())
                        {
                                        ?>    
									...
									<div class="item">
										<div class="glry-w3agile-grids agileits"> 
											<a href="SingleProduct.php?id=<?php echo $DisplayAsCat['id']; ?>"><img src="meadmin/web/pro_img/<?php echo $DisplayAsCat['ProductImage']; ?>" alt="img"></a>
											<div class="view-caption agileits-w3layouts">           
												<h4><a href="SingleProduct.php?id=<?php echo $DisplayAsCat['id']; ?>"><?php echo $DisplayAsCat['GuitarName']; ?></a></h4>
												<p></p>
												<h4>Rs.<?php echo $DisplayAsCat['GuitarPrice']; ?></h4>
												<form action="SingleProduct.php?id=<?php echo $DisplayAsCat['id']; ?>" method="post">
													
													<button type="submit" class="w3ls-cart" > View Product</button>
												</form>
											</div>        
										</div>    
									</div>
						...
						<div role="tabpanel" class="tab-pane fade" id="james" aria-labelledby="james-tab">
							<div class="tabcontent-grids">
								...
								<div id="owl-demo2" class="owl-carousel"> 
									<?php 
                                    $ProAsBrand = $NepdevG->NepdevViewProBrand();
                                     while($DisplayProAsBrand=$ProAsBrand->fetch_assoc())
                                     {
                                    ?>
                                    ...
                                    <div class="item">
										<div class="glry-w3agile-grids agileits"> 
											<div class="new-tag"><h6>New</h6></div>
											<a href="SingleProduct.php?id=<?php echo $DisplayProAsBrand['id']; ?>"><img src="meadmin/web/pro_img/<?php echo $DisplayProAsBrand['ProductImage']; ?>" alt="img"></a>
											<div class="view-caption agileits-w3layouts">           
												<h4><a href="SingleProduct.php?id=<?php echo $DisplayProAsBrand['id']; ?>"><?php echo $DisplayProAsBrand['GuitarName']; ?></a></h4>
												<p></p>
												<h4>Rs.<?php echo $DisplayProAsBrand['GuitarPrice']; ?></h4>
												<form action="SingleProduct.php?id=<?php echo $DisplayProAsBrand['id']; ?>" method="post">
													<button type="submit" class="w3ls-cart" ><i class="fa fa-cart-plus" aria-hidden="true"></i> View Guitar</button>
												</form>
											</div>         
										</div>  
									</div>
						...
						<div role="tabpanel" class="tab-pane fade" id="decor" aria-labelledby="decor-tab">
							<div class="tabcontent-grids">
								...
								<div id="owl-demo3" class="owl-carousel"> 
                                    ...
                                    $HightToLog =$NepdevG->NepdevViewProDesc();
                                    while($HightToLowDis = $HightToLog->fetch_assoc())
                                    {
                                    ?>
									<div class="item">
										<div class="glry-w3agile-grids agileits"> 
											<div class="new-tag"><h6>Sale</h6></div>
											<a href="SingleProduct.php?id=<?php echo $HightToLowDis['id']; ?>"><img src="meadmin/web/pro_img/<?php echo $HightToLowDis['ProductImage']; ?>"></a>
											<div class="view-caption agileits-w3layouts">           
												<h4><a href="SingleProduct.php?id=<?php echo $HightToLowDis['id']; ?>"><?php echo $HightToLowDis['GuitarName']; ?></a></h4>
												<p></p>
												<h4>Rs.<?php echo $HightToLowDis['GuitarPrice']; ?></h4>
												<form action="SingleProduct.php?id=<?php echo $HightToLowDis['id']; ?>" method="post">
						...
						<div role="tabpanel" class="tab-pane fade" id="sports" aria-labelledby="sports-tab">
                            ...
                            $DisplayasAsc = $NepdevG->NepdevViewProAsc();
                        while($DisplayAscPro =$DisplayasAsc->fetch_assoc())
                        {
                                    ?>    
									<div class="item">
										<div class="glry-w3agile-grids agileits"> 
											
											<a href="SingleProduct.php?id=<?php echo $DisplayAscPro['id']; ?>"><img src="meadmin/web/pro_img/<?php echo $DisplayAscPro['ProductImage']; ?>" alt="img"></a>
											<div class="view-caption agileits-w3layouts">           
												<h4><a href="SingleProduct.php?id=<?php echo $DisplayAscPro['id']; ?>"><?php echo $DisplayAscPro['GuitarName'];  ?></a></h4>
												<p></p>
												<h4>Rs.<?php echo $DisplayAscPro['GuitarPrice'];  ?></h4>
												<form action="SingleProduct.php?id=<?php echo $DisplayAscPro['id']; ?>" method="post">
													<button type="submit" class="w3ls-cart" ><i class="fa fa-cart-plus" aria-hidden="true"></i> View Product</button>
												</form>
											</div>         
										</div>  
			...
			<div class="footer-info w3-agileits-info">
				<div class="col-md-4 address-left agileinfo">
					<div class="footer-logo header-logo">
						<h2><a href="index.html"><span>L</span>okanthali <i>Store</i></a></h2>
						<h6>Your stores. Your place.</h6>
					</div>
					<ul>
						<li><i class="fa fa-map-marker"></i> 123 San Sebastian, New York City USA.</li>
						<li><i class="fa fa-mobile"></i> 9868000000 </li>
						<li><i class="fa fa-phone"></i> 9818000000 </li>
	...
	<div class="copy-right"> 
		<div class="container">
			<p>© 2018 Lokanthali Store . All rights reserved | Design by <a href="http://w3layouts.com"> W3layouts.</a>Developed By Ravi Khadka</p>
		</div>
	</div> 
	<!-- cart-js -->
