...
<body>
    <?php include "NepdevSetting/Config.php";
     ...
     $Pid = $_GET['id'];
    $SuccessDisplaySingleProduct = $NepdevG->NepdevSingleProduct($Pid);
    $SingleGuitarFetch = $SuccessDisplaySingleProduct->fetch_assoc();
		...
		<div class="container">  
				...
				<div class="single-page-row" id="detail-21">
					<div class="col-md-6 single-top-left">	
						<div class="flexslider">
							<ul class="slides">
								<li data-thumb="meadmin/web/pro_img/<?php echo $SingleGuitarFetch['ProductImage']; ?>">
									<div class="thumb-image detail_images"> <img src="meadmin/web/pro_img/<?php echo $SingleGuitarFetch['ProductImage']; ?>" data-imagezoom="true" class="img-responsive" alt=""> </div>
								</li>
								<li data-thumb="meadmin/web/pro_img/<?php echo $SingleGuitarFetch['ProductImage']; ?>">
									 <div class="thumb-image"> <img src="meadmin/web/pro_img/<?php echo $SingleGuitarFetch['ProductImage']; ?>" data-imagezoom="true" class="img-responsive" alt=""> </div>
								</li>
                    ...
                    <?php 
                     ...
                     { 
                          ...
                          {
                               echo "<script>window.location='meuser/web/Home.php?addcart';</script>";
                               
                              }
                         else
                         {
                            echo "<script>alert('You Must Login 1st Press Ok To Process'); window.location='meuser/web';</script>"; 
                         }
					...
					<div class="col-md-6 single-top-right">
                              <form method="post">
						<h3 class="item_name"><?php echo $SingleGuitarFetch['GuitarName']; ?>
                        <small><?php echo $SingleGuitarFetch['GuitarBrand']; ?> | <?php echo $SingleGuitarFetch['GuitarCategory']; ?></small>
                        </h3>
						<p>Processing Time: Item will be shipped out within 2-3 working days. </p>
						
						<div class="single-price">
							<ul>
								<li>Rs.<?php echo $SingleGuitarFetch['GuitarPrice']; ?></li>   
							</ul>	
						</div> 
						<p class="single-price-text">Overview: <?php echo $SingleGuitarFetch['GuitarOverview']; ?> </p>
		             
                  
							
                      
                            <input type="submit" name="AddToCart" class="w3ls-cart" value="Add To Cart">
			...
			<div class="recommend">
				...
				<div id="owl-demo5" class="owl-carousel">
                   <?php 
                $SelectGuitarCategory = $SingleGuitarFetch['GuitarCategory'];
                $RelatedPro = $NepdevG->NepdevViewProductAsCat($SelectGuitarCategory);
                
                while($RelatedProDisplay =$RelatedPro->fetch_assoc())
                {
                ?>
					<div class="item">
						<div class="glry-w3agile-grids agileits">
						
							<a href="SingleProduct.php?id=<?php echo $RelatedProDisplay['id']; ?>"><img src="meadmin/web/pro_img/<?php echo $RelatedProDisplay['ProductImage']; ?>" alt="img"></a>
							<div class="view-caption agileits-w3layouts">           
								<h4><a href="SingleProduct.php?id=<?php echo $RelatedProDisplay['id']; ?>"><?php echo $RelatedProDisplay['GuitarName']; ?></a></h4>
								<p></p>
								<h4>Rs.<?php echo $RelatedProDisplay['GuitarPrice']; ?></h4>
								<form action="#" method="post">
									
									<input type="hidden" name="w3ls_item" value="<?php echo $RelatedProDisplay['GuitarName']; ?>" /> 
									<input type="hidden" name="amount" value="<?php echo $RelatedProDisplay['GuitarPrice']; ?>" /> 
