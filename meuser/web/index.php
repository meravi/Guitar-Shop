...
<div class="registration">
		...
		<script>
		 ...
		 <div class="registration_form">
			 ...
			 if(isset($_POST['MeuserSignup']))
			 {
				 
				 $MeuserFname = $_POST['MeuserFname'];
				 $MeuserLname = $_POST['MeuserLname'];
				 $MeuserEmail = $_POST['MeuserEmail'];
				 $MeuserGender = $_POST['MeuserGender'];
				 $MeuserPassword = $_POST['MeuserPassword'];
				 if($MeuserFname=="" AND $MeuserLname=="" AND $MeuserEmail=="" AND $MeuserGender=="" AND $MeuserPassword=="")
				 {
					 echo "<script>alert('Dont leave anyfield');</script>";
                 ...
                 elseif($MeuserPassword=="")
                 {
                     echo "<script>alert('Enter Your Password');</script>";
                 }
				 else
				 {
				 $SuccessIns = $NepdevG->NepdevNewUser($MeuserFname,$MeuserLname,$MeuserEmail,$MeuserGender,$MeuserPassword);
				 if($SuccessIns==true)
				 {
					 ...
					 {
						 echo "<script>alert('Email Already Taken Please Try Another.');</script>";
					 }
		 ...
		 <!-- Form -->
			<form method="post">
				<div>
					<label>
						<input placeholder="first name:" type="text" tabindex="1"  autofocus="" name="MeuserFname">
					</label>
				</div>
				<div>
					<label>
						<input placeholder="last name:" type="text" tabindex="2" required="" autofocus="" name="MeuserLname">
					</label>
				</div>
				<div>
					<label>
						<input placeholder="email address:" type="email" tabindex="3" required="" name="MeuserEmail">
					</label>
				</div>
				<div class="sky-form">
					<div class="sky_form1">
						<select name="MeuserGender">
				...
				<div>
					<label>
						<input placeholder="password" type="password" tabindex="4" required="" name="MeuserPassword">
					</label>
				</div>						
				<div>
					<input type="submit" value="create an account" name="MeuserSignup">
				</div>
			</form>
			<!-- /Form -->
		</div>
	...
	<div class="registration_left">
		<h2>existing user</h2>
		 ...
		 <!-- Form -->
             ...
             if(isset($_POST['MeuserLogin']))
             {
                 $MeuserLoginEmail = $_POST['MeuserLoginEmail'];
                 $MeuserLoginPassword = $_POST['MeuserLoginPassword'];
                 if($MeuserLoginEmail=="" AND $MeuserLoginPassword=="")
                 {
                     echo "<script>alert('Please Enter User Name And Password');</script>";
                 }
                 elseif($MeuserLoginEmail=="")
                 {
                     echo "<script>alert('Please Enter Your Email');</script>";
                 }
                 elseif($MeuserLoginPassword=="")
                 {
                 ...
                 $NepdevUserSuccess = $NepdevG->NepdevUserLogin($MeuserLoginEmail,$MeuserLoginPassword);
                 if($NepdevUserSuccess==1)
                 {
              
                     $_SESSION['userlogin'] = "$MeuserLoginEmail";
                     echo "<script>window.location='Home.php';</script>";
                 }
                 else
                 {
                  echo "<script>alert('Email Or Password Does Not Matchd');</script>";
                 }
             } }
             ?>
			<form method="post">
				<div>
					<label>
						<input type="text" placeholder="email:"  name="MeuserLoginEmail">
					</label>
				</div>
				<div>
					<label>
						<input type="password" placeholder="password" name="MeuserLoginPassword">
					</label>
				</div>						
				<div>
					<input type="submit" value="sign in" name="MeuserLogin">
				</div>
			</form>
			<!-- /Form -->
