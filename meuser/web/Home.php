...
{
    echo "<script>alert('Now You Can Add Cart And Checkout Thank You.');</script>";
}
...
{
    $UserLoginEmail = $_SESSION['userlogin'];
		...
		<div class="sidebar-menu">
			...
			<div class="menu">
				<ul id="menu">
					...
					<li id="menu-academico"><a href="Home.php?NepdevAdmin=addcart"><i class="fa fa-table"></i> <span>View My Bags</span></a>
					</li>
                    <li id="menu-academico-avaliacoes"><a href="Home.php?NepdevAdmin=NepdevViewGuitar"><i class="fa fa-table"></i>View All Guitar</a></li>
